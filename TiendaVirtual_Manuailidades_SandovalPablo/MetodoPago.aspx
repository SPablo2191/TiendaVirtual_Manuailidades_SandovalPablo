<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetodoPago.aspx.cs" Inherits="TiendaVirtual_Manuailidades_SandovalPablo.MetodoPago" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link href="Estilos/EstilometodoPago.css" rel="stylesheet" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Mi huella-MetodoPago</title>
</head>
<body>
    <form method="post" id="MetodoPago_Form" runat="server">
...
<nav>
        ...
        <!--recuadro de metodo de pago-->
        <section>
            <div class="contenedor">
                <asp:Label ID="lbl_titulo" runat="server" Text="Detalles de Boleta:"></asp:Label>
                <hr />
                <asp:Label ID="Lbl_modo" runat="server" Text="Modos de Pago:"></asp:Label>
                                <br />

                <asp:DropDownList ID="DropDownList1" CssClass="ddp-estilo" runat="server" Width="433px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True">
                     <asp:ListItem Value="0">Seleccione un modo de pago</asp:ListItem>
                </asp:DropDownList>
                <br />
                <br />
                ...
                <asp:Button ID="btn_siguiente"  CssClass="botones" runat="server" Text="SIGUIENTE" BorderStyle="None" Width="152px" OnClick="btn_siguiente_Click" />
                                <br />
                &nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label1" runat="server" Text="Elija una opcion para continuar" Visible="False"></asp:Label>
                <br />
                <br />
                <br />
