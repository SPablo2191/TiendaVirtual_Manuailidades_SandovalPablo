<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaPedidos.aspx.cs" Inherits="TiendaVirtual_Manuailidades_SandovalPablo.ListaPedidos" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Mi Huella - Lista de Pedidos</title>
</head>
<body>
        <form method="post" id="lp_Form" runat="server">
...
<nav>
    ...
    <!-- seccion de empleados -->
            ...
            <div class="contenedor">
                ...
                <asp:Label ID="Label1" runat="server" Text="Para confirmar un pedido como 'entregado' realize doble click en el boton 'Marcar como entregado' para el respectivo pedido."></asp:Label>
                            <div class="grid">
                                    <asp:GridView ID="GridView1" CssClass="tabla-compras" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Height="16px" Width="789px" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                        <Columns>
                                            <asp:ButtonField CommandName="select" HeaderText="Opciones" Text="Marcar como entregado" >
